...
package com.google.classyshark.gui.panel.gmsdetect;
...
public class GmsDetectPanel extends JPanel {
    private DefaultTreeModel treeModel;
    private JTree jTree;
    private ViewerController viewerController;
    private final Theme theme = GuiMode.getTheme();

    public GmsDetectPanel(ViewerController viewerController, File file) throws HeadlessException {
        this(viewerController);
        loadFile(file);
        theme.applyTo(this);
    }

    public GmsDetectPanel(ViewerController viewerController) throws HeadlessException {
